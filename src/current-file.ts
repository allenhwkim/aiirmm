...
export class CurrentFile {
  ...
  set name(val) { 
    this._name = val; 
    StepperStorage.setItem('currentFormflow.name', val);
  }
  ...
  set modified(val) { 
    this._modified = val; 
    StepperStorage.setItem('currentFormflow.modified', val);
  }
  ...
  set selected(val) { 
    this._selected = val; 
    StepperStorage.setItem('currentFormflow.selected', val);
  }
  ...
  constructor(form?, chartEl?) {
    ...
    } else if (StepperStorage.getItem('currentFormflow')) {
      this.name = StepperStorage.getItem('currentFormflow.name');
      this.chart = StepperStorage.getItem('currentFormflow.chart');
    } else {
